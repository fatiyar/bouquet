...
<header>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <a class="navbar-brand" href="#">Florist Bouquet</a>
...
<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="gambar/SE3.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Ring</h5>
        <p>Give gifts to loved ones!</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="gambar/FL1.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Flowers</h5>
        <p>Give gifts to loved ones!</p>
      </div>
    ...
    <div class="carousel-item">
      <img src="gambar/MO1.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Money</h5>
        <p>Give gifts to loved ones!</p>
      </div>
