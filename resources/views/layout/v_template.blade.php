...
<head>
  ...
  <title>@yield('title') | Florist Bouquet</title>
  ...
  <link rel="stylesheet" href="{{asset('template')}}//tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- iCheck -->
  <link rel="stylesheet" href="{{asset('template')}}//icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- JQVMap -->
  <link rel="stylesheet" href="{{asset('template')}}//jqvmap/jqvmap.min.css">
  <!-- Theme style -->
...
<div class="wrapper">
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              <div class="media-body">
                ...
                <p class="text-sm">ready for baloon?</p>
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 Hours Ago</p>
              </div>
            </div>
            <!-- Message End -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{asset('template')}}/index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Florist Bouquet</span>
    </a>
